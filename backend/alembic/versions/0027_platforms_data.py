...
def upgrade() -> None:
    ...
    with op.batch_alter_table("platforms", schema=None) as batch_op:
        add_column_if_not_exists(
            op, "platforms", sa.Column("category", sa.String(length=50), nullable=True)
        )
        add_column_if_not_exists(
            op, "platforms", sa.Column("generation", sa.Integer(), nullable=True)
        )
        add_column_if_not_exists(
            op,
            "platforms",
        ...
        add_column_if_not_exists(
            op, "platforms", sa.Column("url", sa.String(length=1000), nullable=True)
        )
        add_column_if_not_exists(
            op,
            "platforms",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("platforms", schema=None) as batch_op:
        drop_column_if_exists(op, "platforms", "url_logo")
        drop_column_if_exists(op, "platforms", "url")
        drop_column_if_exists(op, "platforms", "family_name")
        drop_column_if_exists(op, "platforms", "family_slug")
        drop_column_if_exists(op, "platforms", "generation")
        drop_column_if_exists(op, "platforms", "category")
        drop_column_if_exists(op, "platforms", "aspect_ratio")
    # ### end Alembic commands ###
