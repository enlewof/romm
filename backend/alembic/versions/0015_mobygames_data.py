...
def upgrade() -> None:
    ...
    with op.batch_alter_table("platforms", schema=None) as batch_op:
        add_column_if_not_exists(
            "platforms", sa.Column("moby_id", sa.Integer(), nullable=True)
        )

    with op.batch_alter_table("roms", schema=None) as batch_op:
        add_column_if_not_exists(
            "roms", sa.Column("moby_id", sa.Integer(), nullable=True)
        )
        add_column_if_not_exists(
            "roms", sa.Column("moby_metadata", CustomJSON(), nullable=True)
        )
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("roms", schema=None) as batch_op:
        drop_column_if_exists("roms", "moby_metadata")
        drop_column_if_exists("roms", "moby_id")

    with op.batch_alter_table("platforms", schema=None) as batch_op:
        drop_column_if_exists("platforms", "moby_id")
