"""Add manual_metadata column and prioritize it in roms_metadata view

Revision ID: 0061_manual_metadata
...
down_revision = "0060_user_ui_settings"
branch_labels = None
depends_on = None
...
def downgrade():
    with op.batch_alter_table("roms", schema=None) as batch_op:
        drop_column_if_exists(batch_op, "manual_metadata")
